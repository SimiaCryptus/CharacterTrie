...
//        com.simiacryptus.ref.wrappers.System.out.println("Found string matches for " + match.getString());
...
//          com.simiacryptus.ref.wrappers.System.out.print("Bit Length: " + bits.bitLength);
...
//        com.simiacryptus.ref.wrappers.System.out.print("Compressed Bytes: " + bits.length);
...
//          log.code(() -> {
//            com.simiacryptus.ref.wrappers.System.out.println(String.format("Sum characteristic string apply %s context and %s lookahead", ctx, l));
//            return trieSum.getGenerator().generateDictionary(dictionarySampleSize, ctx, "", l, true);
//          });
//          log.code(() -> {
//            com.simiacryptus.ref.wrappers.System.out.println(String.format("Product characteristic string apply %s context and %s lookahead", ctx, l));
//            return trieProduct.getGenerator().generateDictionary(dictionarySampleSize, ctx, "", l, true);
//          });
//          log.code(() -> {
//            com.simiacryptus.ref.wrappers.System.out.println(String.format("Negative characteristic string apply %s context and %s lookahead", ctx, l));
//            return negativeVector.getGenerator().generateDictionary(dictionarySampleSize, ctx, "", l, true);
//          });
//          log.code(() -> {
//            com.simiacryptus.ref.wrappers.System.out.println(String.format("Positive characteristic string apply %s context and %s lookahead", ctx, l));
...
//          com.simiacryptus.ref.wrappers.System.out.println(String.format("%s -> %s", str, prob));
...
//          com.simiacryptus.ref.wrappers.System.out.println(String.format("Indexing %s", article.getTitle()));
//          trie.addDocument(article.getText());
//        });
//        com.simiacryptus.ref.wrappers.System.out.println(String.format("Indexing %s bytes of documents",
//          trie.getIndexedSize()));
//        trie.index(5, 1);
//        return trie;
//      });
...
//        com.simiacryptus.ref.wrappers.System.out.println(String.format("%s in ram, %s bytes in serialized form, %s%% compression",
...
//          com.simiacryptus.ref.wrappers.System.out.println(String.format("Serialized %s: %s chars -> %s bytes (%s%%) in %s sec; %s",
...
//          com.simiacryptus.ref.wrappers.System.out.println(String.format("Deserialized %s bytes -> %s chars in %s sec",
...
//        com.simiacryptus.ref.wrappers.System.out.println(String.format("Tree Verified: %s", verified));
//      });
//    }
//  }
//
...
//        log.h3("Keywords");
//        log.code(() -> {
//          return articleTrie.getAnalyzer().setVerbose(com.simiacryptus.ref.wrappers.System.out).keywords(testArticle.getText())
//            .stream().map(s -> '"' + s.toString() + '"').collect(Collectors.joining(", "));
//        });
//        log.h3("Tokenization");
//        log.code(() -> {
//          return articleTrie.getAnalyzer().setVerbose(com.simiacryptus.ref.wrappers.System.out).splitChars(testArticle.getText())
//            .stream().map(s -> '"' + s.toString() + '"').collect(Collectors.joining(", "));
//        });
//      });
//    }
...
//          return referenceTrie.getAnalyzer().setVerbose(com.simiacryptus.ref.wrappers.System.out).splitMatches(testArticle.getText(), 2);
//        });
//        log.h3("Keywords");
//        log.code(() -> {
...
//        log.code(() -> {
//          return referenceTrie.getAnalyzer().setVerbose(com.simiacryptus.ref.wrappers.System.out).spelling("|" + testArticle.getText() + "|");
//        });
//      });
//    }
//  }
...
//          com.simiacryptus.ref.wrappers.System.out.println(String.format("Serialized %s: %s chars -> %s bytes (%s%%) in %s ms",
